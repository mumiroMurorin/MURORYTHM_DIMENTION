...
{
    public class JudgementSpawner_DynamicRightward : JudgementEffectSpawner
    {
        [Header("判定出現半径")]
        ...
        {
            NoteData_DynamicGroundRightward noteData = judgementData.NoteData as NoteData_DynamicGroundRightward;
