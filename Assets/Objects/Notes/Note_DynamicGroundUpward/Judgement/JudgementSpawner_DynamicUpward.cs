...
{
    public class JudgementSpawner_DynamicUpward : JudgementEffectSpawner
    {
        [Header("判定出現半径")]
        ...
        {
            NoteData_DynamicGroundUpward noteData = judgementData.NoteData as NoteData_DynamicGroundUpward;
