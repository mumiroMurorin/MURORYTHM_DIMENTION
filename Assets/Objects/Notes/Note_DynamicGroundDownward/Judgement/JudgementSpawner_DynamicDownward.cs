...
{
    public class JudgementSpawner_DynamicDownward : JudgementEffectSpawner
    {
        [Header("判定出現半径")]
        ...
        {
            NoteData_DynamicGroundDownward noteData = judgementData.NoteData as NoteData_DynamicGroundDownward;
