...
namespace RayFireEditor
{
    ...
    public class RayfireShatterEditor : Editor
    {
        ...
        const int   adv_rel_max     = 5;
        const float adv_abs_min     = 0;
        const float adv_abs_max     = 10f;
        const int   adv_element_min = 1;
        const int   adv_element_max = 100;
        const int   adv_faces_min = 0;
        const int   adv_faces_max = 30;
        ...
        SerializedProperty sp_aabb_cld;
        ...
        private void OnEnable()
        {
            ...
            sp_engine          = serializedObject.FindProperty(nameof(shatter.engineType));
            ...
            sp_adv_face     = serializedObject.FindProperty(nameof(shatter.advanced) + "." + nameof(shatter.advanced.faceFlt));
            ...
            sp_aabb_cld      = serializedObject.FindProperty(nameof(shatter.advanced) + "." + nameof(shatter.advanced.aabbCloud));
        ...
        void GUI_Type_Bricks()
        {
            ...
            if (shatter.engineType == RayfireShatter.RFEngineType.V1)
            {
        ...
        void GUI_Material()
        {
            ...
            if (sp_mat_uve.boolValue == true)
            {
                ...
                if (shatter.engineType == RayfireShatter.RFEngineType.V2)
                {
                    EditorGUI.BeginChangeCheck();
        ...
        void GUI_Filters()
        {
            ...
            if (exp_fil == true)
            {
                ...
                {
                    EditorGUI.BeginChangeCheck(); 
                    RFUI.IntSlider (sp_adv_face, adv_faces_min, adv_faces_max, TextSht.gui_adv_face);
                    if (EditorGUI.EndChangeCheck() == true)
                        InteractiveChange();
                }
                EditorGUI.indentLevel--;
        ...
        void GUI_Shell()
        {
            ...
            if (sp_shl_en.boolValue == true)
            {
                ...
                RFUI.PropertyField (sp_shl_thick, TextSht.gui_shl_thick);
        ...
        void GUI_Part()
        {
            ...
            if (sp_aabb_en.boolValue == true)
            {
                ...
                RFUI.PropertyField (sp_aabb_cld, TextSht.gui_aabb_cld);
                RFUI.PropertyField (sp_aabb_sep, TextSht.gui_aabb_sep);
            }
            if (EditorGUI.EndChangeCheck() == true)
            {
                CheckPropertyChange(shatter.advanced.aabbObject, sp_aabb_obj);
                InteractiveChange();
            }
        }
        ...
        void GUI_CenterV2()
        {
            ...
            if (EditorGUI.EndChangeCheck() == true)
            {
                CheckPropertyChange(shatter.advanced.centerBias, sp_cn_obj);
                InteractiveChange();
            }
        }
        ...
        private void OnSceneGUI()
        {
            ...
            // Point3 handle
            if (shatter.engineType == RayfireShatter.RFEngineType.V1 && shatter.showCenter == true)
            {
