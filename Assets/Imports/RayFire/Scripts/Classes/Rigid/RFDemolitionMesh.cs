    ...
    public class RFDemolitionMesh
    {
        ...
        public static bool DemolishMeshV2(RayfireRigid scr)
        {
            ...
            if (scr.mshDemol.HasEngineAndMeshes == false)
            {
                ...
                RayfireMan.Log(scr.name + " V2 Cache Fragments " + stopWatch.Elapsed.TotalMilliseconds + " ms.");
                ...
                if (scr.mshDemol.HasEngineAndMeshes == true)
                {
                    ...
                    stopWatch2.Stop();
                    RayfireMan.Log(scr.name + " V2 Create Fragments " + stopWatch2.Elapsed.TotalMilliseconds + " ms.");
                    
                    stopWatch0.Stop();
                    RayfireMan.Log(scr.name + " V2 Total Time " + stopWatch0.Elapsed.TotalMilliseconds + " ms.");
                    return true;
                }
            }
        ...
        static List<RayfireRigid> CreateFragments (RayfireRigid scr)
        {
            ...
            if (scr.dmlTp == DemolitionType.Runtime && scr.mshDemol.ch.MultiFrameState == true)
            {
        ...
        static void CacheRuntimeV1 (RayfireRigid scr)
        {
            ...
            // Cache meshes
            if (scr.mshDemol.ch.MultiFrameState == false)
                CacheInstant(scr);
            else
                scr.CacheFramesV1();
        }
