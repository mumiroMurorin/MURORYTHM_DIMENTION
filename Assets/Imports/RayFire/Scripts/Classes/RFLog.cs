...
namespace RayFire
{
    ...
    public static class RFLog
    {
        ...
        public const string rig_bnd    = ". All bounds corners on the same side of slicing plane. Slicing skipped.";
        ...
        public const string rig_quot   = ". Demolition Time Quota for this frame reached.";
        public const string rig_qskp   = " Demolition skipped.";
        public const string rig_qpst   = " Demolition postponed to next frame.";
