...
public class NoteFactory_DynamicGroundUpward : NoteFactory<NoteData_DynamicGroundUpward>
{
    ...
    public override void Initialize(NoteFactoryInitializingData initializingData)
    {
        ...
        judgementSettings = initializingData.GetJudgementSettings<DynamicNoteJudgementConfig>(NoteType.DynamicGroundUpward);
    }

    public override NoteObject<NoteData_DynamicGroundUpward> Spawn(NoteData_DynamicGroundUpward data, INotePositionCalculator positionCalculator)
    {
        // 生成
        NoteObject<NoteData_DynamicGroundUpward> note = GenerateNoteInstance(ConvertNoteData(data));
    ...
    private NoteData_DynamicGroundUpward ConvertNoteData(NoteData_DynamicGroundUpward data)
    {
        // ノーツデータにいろいろ追加
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    private NoteObject<NoteData_DynamicGroundUpward> GenerateNoteInstance(NoteData_DynamicGroundUpward data)
    {
    ...
    /// 位置調整など
    /// </summary>
    private void SetTransform(NoteObject<NoteData_DynamicGroundUpward> note, float spawnZ)
    {
        // 動く地面を親登録
