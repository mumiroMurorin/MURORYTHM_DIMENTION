...
public class InteractNoteEffectSpawner_SpaceHoldRelay : InteractNoteEffectSpawner
{
    ...
    public override GameObject Spawn(NoteJudgementData judgementData)
    {
        ...
        SetDataForEffect(obj, judgementData.NoteData as NoteData_SpaceHoldRelay);
        return obj;
    }
    ...
    private void SetDataForEffect(GameObject effectObject, NoteData_SpaceHoldRelay noteData)
    {
        if (!effectObject.TryGetComponent(out IInteractNoteEffectController<NoteData_SpaceHoldRelay> effect)) { return; }
