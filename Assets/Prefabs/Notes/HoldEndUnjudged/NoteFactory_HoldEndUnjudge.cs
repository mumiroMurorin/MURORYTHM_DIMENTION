...
public class NoteFactory_HoldEndUnjudge : NoteFactory<NoteData_HoldEndUnjudge>
{
    ...
    private NoteData_HoldEndUnjudge ConvertNoteData(NoteData_HoldEndUnjudge data)
    {
        // ノーツデータにいろいろ追加
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    private NoteObject<NoteData_HoldEndUnjudge> GenerateNoteInstance(NoteData_HoldEndUnjudge data)
    {
        ...
        // コンポーネントを取得
        NoteObject<NoteData_HoldEndUnjudge> note = origin.GetComponent<NoteObject<NoteData_HoldEndUnjudge>>();
