...
public class InteractNoteEffectSpawner_SpaceBreak : InteractNoteEffectSpawner
{
    ...
    public override GameObject Spawn(NoteJudgementData judgementData)
    {
        ...
        SetDataForEffect(obj, judgementData.NoteData as NoteData_SpaceBreak);
        return obj;
    }
    ...
    private void SetDataForEffect(GameObject effectObject, NoteData_SpaceBreak noteData)
    {
        if (!effectObject.TryGetComponent(out IInteractNoteEffectController<NoteData_SpaceBreak> effect)) { return; }
