...
public class NoteFactory_DynamicGroundRightward : NoteFactory<NoteData_DynamicGroundRightward>
{
    ...
    public override void Initialize(NoteFactoryInitializingData initializingData)
    {
        ...
        judgementSettings = initializingData.GetJudgementSettings<DynamicNoteJudgementConfig>(NoteType.DynamicGroundRightward);
    }
    ...
    private NoteData_DynamicGroundRightward ConvertNoteData(NoteData_DynamicGroundRightward data)
    {
        // ノーツデータにいろいろ追加
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    private NoteObject<NoteData_DynamicGroundRightward> GenerateNoteInstance(NoteData_DynamicGroundRightward data)
    {
        ...
        // コンポーネントを取得
        NoteObject<NoteData_DynamicGroundRightward> note = origin.GetComponent<NoteObject<NoteData_DynamicGroundRightward>>();
