...
public class InteractNoteEffectSpawner_SpaceHoldRelayHidden : InteractNoteEffectSpawner
{
    ...
    public override GameObject Spawn(NoteJudgementData judgementData)
    {
        ...
        SetDataForEffect(obj, judgementData.NoteData as NoteData_SpaceHoldRelayHidden);
        return obj;
    }
    ...
    private void SetDataForEffect(GameObject effectObject, NoteData_SpaceHoldRelayHidden noteData)
    {
        if (!effectObject.TryGetComponent(out IInteractNoteEffectController<NoteData_SpaceHoldRelayHidden> effect)) { return; }
