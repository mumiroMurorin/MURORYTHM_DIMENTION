...
public class InteractNoteEffectSpawner_HoldRelayHidden : InteractNoteEffectSpawner
{
    ...
    public override GameObject Spawn(NoteJudgementData judgementData)
    {
        ...
        SetDataForEffect(obj, judgementData.NoteData as NoteData_HoldRelayHidden);
        return obj;
    }
    ...
    private void SetDataForEffect(GameObject effectObject, NoteData_HoldRelayHidden noteData)
    {
        if (!effectObject.TryGetComponent(out IInteractNoteEffectController<NoteData_HoldRelayHidden> effect)) { return; }
