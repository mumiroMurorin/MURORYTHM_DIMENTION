...
public class NoteFactory_HoldRelayHidden : NoteFactory<NoteData_HoldRelayHidden>
{
    ...
    public override NoteObject<NoteData_HoldRelayHidden> Spawn(NoteData_HoldRelayHidden data)
    {
        // 生成
        NoteObject<NoteData_HoldRelayHidden> note = GenerateNoteInstance(ConvertNoteData(data));
    ...
    private NoteData_HoldRelayHidden ConvertNoteData(NoteData_HoldRelayHidden data)
    {
        // ノーツデータにいろいろ追加
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    private NoteObject<NoteData_HoldRelayHidden> GenerateNoteInstance(NoteData_HoldRelayHidden data)
    {
    ...
    private GameObject GenerateNoteObject(int size)
    {
        ...
        foreach (Transform t in pre.transform)
        {
            ...
            if (d != null) { d.AddDeformer(groundDeformer); }
        }
