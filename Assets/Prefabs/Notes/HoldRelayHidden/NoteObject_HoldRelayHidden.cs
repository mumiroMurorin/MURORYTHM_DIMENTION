...
/// タッチノーツにアタッチされるクラス
/// </summary>
public class NoteObject_HoldRelayHidden : NoteObject<NoteData_HoldRelayHidden>
{
...
/// </summary>
public class NoteData_HoldRelayHidden : INoteData, IJudgableNoteData
{
    public NoteType NoteType => NoteType.HoldRelayHidden;
