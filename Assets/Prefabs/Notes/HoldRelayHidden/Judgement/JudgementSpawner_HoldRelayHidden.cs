...
public class JudgementSpawner_HoldRelayHidden : JudgementEffectSpawner
{
    [Header("îªíËèoåªîºåa")]
    ...
    {
        if (judgementData.NoteData is not NoteData_HoldRelayHidden noteData) { return Vector3.zero; }
