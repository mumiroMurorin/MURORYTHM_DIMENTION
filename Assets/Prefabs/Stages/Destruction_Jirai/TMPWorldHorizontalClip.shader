Shader "Notes/Stages/WorldTMPHorizontalClip"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float GetWorldClipAlpha(float3 worldPos)
            {
                ...
                return saturate(min(remain.x / softness.x, remain.y / softness.y));
            }
            ...
            fixed4 PixShader(pixel_t input) : SV_Target
            {
                ...
                return faceColor * input.color.a * GetWorldClipAlpha(input.worldPos);
            }
