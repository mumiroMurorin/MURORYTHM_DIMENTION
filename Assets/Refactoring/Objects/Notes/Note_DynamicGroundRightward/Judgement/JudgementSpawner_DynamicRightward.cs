...
{
    public class JudgementSpawner_DynamicLeftward : JudgementEffectSpawner
    {
        [Header("判定出現半径")]
        ...
        {
            NoteData_DynamicGroundLeftward noteData = judgementData.NoteData as NoteData_DynamicGroundLeftward;
