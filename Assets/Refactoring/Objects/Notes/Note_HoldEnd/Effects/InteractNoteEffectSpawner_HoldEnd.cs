...
{
    public class InteractNoteEffectSpawner_HoldEnd : InteractNoteEffectSpawner
    {
        ...
        {
            return judgementData.NoteData.NoteType == NoteType.HoldEnd;
        }
        ...
        public override GameObject Spawn(NoteJudgementData judgementData)
        {
            ...
            SetDataForEffect(obj, judgementData.NoteData as NoteData_HoldEnd);
            return obj;
        }
        ...
        private void SetDataForEffect(GameObject effectObject, NoteData_HoldEnd noteData)
        {
            if (!effectObject.TryGetComponent(out IInteractNoteEffectController<NoteData_HoldEnd> effect)) { return; }
