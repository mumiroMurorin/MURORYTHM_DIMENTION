...
namespace Refactoring
{
    public class NoteFactory_HoldRelay : NoteFactory<NoteData_HoldRelay>
    {
        ...
        public override NoteObject<NoteData_HoldRelay> Spawn(NoteData_HoldRelay data)
        {
            // 生成
        ...
        /// 位置調整など
        /// </summary>
        private void SetTransform(NoteObject<NoteData_HoldRelay> note, NoteData_HoldRelay data)
        {
            // 位置の調整
