Shader "Hidden/SpaceHold/ScreenSpaceOutlineCoverageAlways"
{
    Properties
    {
        _CoverageStep("Coverage Step", Float) = 0.01
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                return fixed4(_CoverageStep, _CoverageStep, _CoverageStep, 1);
            }
            ENDCG
        }
    }
