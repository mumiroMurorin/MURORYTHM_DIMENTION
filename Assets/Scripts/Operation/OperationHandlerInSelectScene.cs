...
public class OperationHandlerInSelectScene : MonoBehaviour
{
    ...
    [SerializeField] SerializeInterface<TransitionerInSelectScene.IPhaseStatusGetterInSelectScene> phaseStatusGetter;
    ...
    private void Bind()
    {
        ...
        // フェードアウトしたら操作を破棄
        phaseStatusGetter?.Value?.PhaseStatus
                .Where(value => value == PhaseStatusInSelectScene.FadeOut)
