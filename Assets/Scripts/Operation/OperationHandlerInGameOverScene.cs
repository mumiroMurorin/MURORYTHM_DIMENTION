...
public class OperationHandlerInGameOverScene : MonoBehaviour
{
    [Label("操作アセットリスト")]
    ...
    [SerializeField] SerializeInterface<TransitionerInGameOverScene.IPhaseStatusGetterInGameOverScene> phaseStatusGetter;
    ...
    public void OnChangePhase(PhaseStatusInGameOverScene phase)
    {
