...
public class OperationHandlerInRhythmGameScene : MonoBehaviour
{
    [Label("操作アセットリスト")]
    ...
    [SerializeField] SerializeInterface<TransitionerInRhythmGameScene.IPhaseStatusGetterInRhythmGameScene> phaseStatusGetter;
    ...
    private void Bind()
    {
        ...
        // フェードアウトしたら操作を破棄
        phaseStatusGetter?.Value?.PhaseStatus
                .Where(value => value == PhaseStatusInRhythmGame.FadeOut)
    ...
    public void OnChangePhase(PhaseStatusInRhythmGame phase)
    {
