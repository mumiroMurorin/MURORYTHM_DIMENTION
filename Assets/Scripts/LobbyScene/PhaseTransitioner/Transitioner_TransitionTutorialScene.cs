...
{
    public class Transitioner_TransitionTutorialScene : IPhaseTransitionerInLobbyScene
    {
        ...
        readonly PhaseStatusInLobbyScene status = PhaseStatusInLobbyScene.TransitionTutorialScene;
        ...
        {
            Debug.Log("ÅyTransitionÅzTransition to \"TransitionTutorialScene\"");
