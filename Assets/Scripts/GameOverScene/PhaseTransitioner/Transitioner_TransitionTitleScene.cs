...
{
    public class Transitioner_TransitionTitleScene : IPhaseTransitionerInGameOverScene
    {
        ...
        readonly PhaseStatusInGameOverScene status = PhaseStatusInGameOverScene.TransitionTitleScene;
        ...
        {
            Debug.Log("ÅyTransitionÅzTransition to \"TransitionTitleScene\"");
