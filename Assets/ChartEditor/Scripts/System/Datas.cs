...
namespace ChartEditor
{
    ...
    public class NoteData
    {
        ...
        public void ChangeRange(float index, bool isRightAnchored)
        {
            ...
            SetRange(shifted);
            Debug.Log($"拡大: range:{string.Join(",", range)}");
        }
        ...
        public void SetAddress(AddressInChart address)
        {
            ...
            SetRange(shifted);
            Debug.Log($"移動: {string.Join(",", shifted)}");
        }
    }
    ...
    public class ChartData
    {
        ...
        public void RemoveNote(NoteData noteData)
        {
            ...
            {
                Debug.LogError($"【System】削除に失敗しました: #{address.BarIndex} {address.SubDivisionIndex} {address.SliderIndex}");
            }
            else
            {
                Debug.Log($"【System】削除: #{address.BarIndex} {address.SubDivisionIndex} {address.SliderIndex}");
